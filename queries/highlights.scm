...
(func_dialect arguments: (func_arg_list (value_use) @variable.parameter))
(llvm_dialect arguments: (func_arg_list (value_use) @variable.parameter))
(block_label (block_arg_list (value_use) @variable.parameter))
