...
ir_count=0
for f in parser.mlir core-ops.mlir attribute.mlir affine-map.mlir affine-set.mlir properties.mlir properties-bytecode-roundtrip.mlir custom-print-parse.mlir distinct-attr.mlir; do
